  ...
  describe WebRoot do
    ...
    describe "#locate" do
      ...
      it "when passed a directory that is in the public_path, returns a Dir representing that directory" do
        ...
        runner.should == JsSpec::Dir.new("#{JsSpec::Server.public_path}/stylesheets", '/stylesheets')
      end
      ...
      it "when passed a file that is in the public_path, returns a File representing that file" do
        ...
        runner.should == JsSpec::File.new("#{JsSpec::Server.public_path}/robots.txt", '/robots.txt')
      end
